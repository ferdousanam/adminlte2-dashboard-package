...
@section('page_title', 'Create User Type')
@section('page_tagline', 'Create User Type')
...
@section('content')
    ...
    <div class="box box-default color-palette-box">
        ...
        <!--begin::Form-->
        <form id="menu-form" action="{{ route('user-type.store') }}" method="POST" class="form-horizontal">
            <div class="box-body">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" id="priority_name" name="priority_name"
                               value="{{ old('priority_name') }}" placeholder="User Type" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="priority_description" class="col-sm-2 control-label">Description:</label>
                    <div class="col-sm-10">
                        <textarea name="priority_description" id="priority_description" class="form-control" rows="10"
                                  placeholder="Type Description">{{ old('priority_description') }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
...
@push('scripts')
    <script>
        ...
        $('#user-types--create-sm').addClass('active');
    </script>
@endpush
